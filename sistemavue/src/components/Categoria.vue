...
methods: {
  ...
  validar(){
    ...
    if(this.nombre.length<1 ||this.nombre.length>50 ){
      this.validaMensaje.push('El nombre de la categoria debe tener entre 1 a 50 caracteres')
    }
    if(this.descripcion.length>250 ){
      this.validaMensaje.push('La descripcion no puede ser mayor a 250 caracteres')
    }
