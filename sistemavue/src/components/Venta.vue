<template>
    <v-layout align-start>
        <v-flex>
            ...
            <v-toolbar text color="white">
                ...
                label="Búsqueda" single-line hide-details v-if="verNuevo==0"></v-text-field>
                <v-spacer></v-spacer>
                    ...
                    <v-container grid-list-md>
                        <v-layout wrap>
                          <v-flex xs12 sm12 md12 lg12 xl12>
                            <v-text-field v-model="texto" @keyup.enter="listarArticulo()" class="text-xs-center" append-icon="mdi-magnify"  label="Búsqueda">
                                  ...
                                  <tbody>
                                      <tr>
                                          <td id="cliente">
                                              ...
                                              <strong>Email:</strong> j{{persona.email}}
                                          </td>
                                      </tr>
                                  </tbody>
                              </table>
        ...
        <v-container grid-list-sm class="pa-4 white" v-if="verNuevo" >
          <v-layout row wrap>
            <v-flex xs12 sm4 md4 lg4 xl4>
              ...
              :items="comprobantes" label="Tipo de comprobante">
            ...
            <v-flex xs12 sm4 md4 lg4 xl4>
              <v-text-field v-model="num_comprobante" label="Número de comprobante"></v-text-field>
            </v-flex>
            ...
            <v-flex xs12 sm12 md12 lg12 xl12>
              <template>
                ...
                <template v-slot:item.cantidad="{ item }">
                  <td class="text-xs-center">{{ articulo }}</td>
                  <td class="text-xs-center"><v-text-field type="number" v-model="item.cantidad"></v-text-field></td>
                </template>
                ...
                <template v-slot:item.subtotal="{ item }">
                  ...
                  <td class="text-xs-center">$ {{ (item.cantidad * item.precio) - item.descuento }}</td>
                </template>
  ...
  export default {
    data(){
        return{
            ...
            { text: 'N° Comprobante', value: 'num_comprobante', sortable: false },
  ...
  methods: {
    ...
    desactivar(){
      ...
      let header={"Token": this.$store.state.token};
      let configuracion={headers : header}
      axios.put('venta/desactivate', {'_id': this.adId}, configuracion)
        .then(function(response){
          me.adModal=0
          me.adAccion=0
          me.adNombre=''
